...
| 13 | Cross-GPU overlap efficiency 30% | **Suspect, not yet withdrawn.** That decode wrote into an uninitialised destination and may have been a no-op. Needs re-running | `session_close_findings.md` |
